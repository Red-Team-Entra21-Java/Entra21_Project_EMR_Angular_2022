...
const routes: Routes = [
  ...
  { path: "new-patient/:name/:cpf/:motherName/:fatherNamer/:genre/:birthDate/:streetName/:numberHome/:district/:city/:state/:country", component: NewPatientComponent,canActivate: [SecurityService]},
